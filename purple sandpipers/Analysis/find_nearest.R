# To find nearest value in a sorted vector
# function returns index of closest value in target dataset

# from https://stats.stackexchange.com/a/161458

# Working code
# The R code implementing this algorithm (dubbed glb below, for "greatest lower bound") takes under two seconds (running on one 3.3 GHz core) to perform 106106 probes into 106106 targets.
